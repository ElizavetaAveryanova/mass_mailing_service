...
class Mailing(models.Model):
    ...
    clients = models.ManyToManyField('client.Client', verbose_name='контакты клиентов')
...
class Log(models.Model):
    ...
    clients = models.ForeignKey('client.Client', on_delete=models.CASCADE, verbose_name='контакты клиентов')
